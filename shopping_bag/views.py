...
def add_to_bag(request, item_id):
    ...
    if size:
        ...
        if item_id in list(bag.keys()):
            ...
            messages.success(request, f'Updated {product.name} to your {bag[item_id]}')  #  success toast
        else:
            bag[item_id] = quantity
            messages.success(request, f'Added {product.name} to your bag')  #  success toast
